...
echo -e "${CYAN}╘════════════════════════════════════════════╛\033[0m"
sleep 0.5
wget -O https://raw.githubusercontent.com/mywtg/wtgtnl1/main/installer/sshinstaller.sh && chmod +x sshinstaller.sh && ./sshinstaller.sh
#install backup
echo -e "${CYAN}╒════════════════════════════════════════════╕\033[0m"
echo -e " \E[0;36;44;1m            Installing Backup Set           \E[0m"
echo -e "${CYAN}╘════════════════════════════════════════════╛\033[0m"
sleep 0.5
wget -O https://raw.githubusercontent.com/mywtg/wtgtnl1/main/installer/backupinstaller.sh && chmod +x backupinstaller.sh && ./backupinstaller.sh
#Instal Xray
echo -e "${CYAN}╒════════════════════════════════════════════╕\033[0m"
echo -e " \E[0;36;44;1m           Installing Xray Services         \E[0m"
echo -e "${CYAN}╘════════════════════════════════════════════╛\033[0m"
sleep 0.5
wget -O https://raw.githubusercontent.com/mywtg/wtgtnl1/main/installer/xrayinstaller.sh && chmod +x xrayinstaller.sh && ./xrayinstaller.sh
wget -O https://raw.githubusercontent.com/mywtg/wtgtnl1/main/installer/websocketinstaller.sh && chmod +x websocketinstaller.sh && ./websocketinstaller.sh
wget -O https://raw.githubusercontent.com/mywtg/wtgtnl1/main/installer/toolsinstaller.sh;chmod +x toolsinstaller.sh;./toolsinstaller.sh
echo -e " INSTALL SISTEM UPD" | lolcat
wget -O https://raw.githubusercontent.com/mywtg/wtgtnl1/main/udp.sh && chmod +x udp.sh && ./udp.sh
clear
