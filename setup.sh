...
clear
BURIQ () {
    curl -sS https://raw.githubusercontent.com/shakboss/supreme/aio/permission/ip > /root/tmp
...
echo -e "${CYAN}╘════════════════════════════════════════════╛\033[0m"
sleep 0.5
wget -q https://raw.githubusercontent.com/shakboss/wtgtnl1/main/installer/sshinstaller.sh && chmod +x sshinstaller.sh && ./sshinstaller.sh
#install backup
echo -e "${CYAN}╒════════════════════════════════════════════╕\033[0m"
echo -e " \E[0;36;44;1m            Installing Backup Set           \E[0m"
echo -e "${CYAN}╘════════════════════════════════════════════╛\033[0m"
sleep 0.5
wget -q https://raw.githubusercontent.com/shakboss/wtgtnl1/main/installer/backupinstaller.sh && chmod +x backupinstaller.sh && ./backupinstaller.sh
#Instal Xray
echo -e "${CYAN}╒════════════════════════════════════════════╕\033[0m"
echo -e " \E[0;36;44;1m           Installing Xray Services         \E[0m"
echo -e "${CYAN}╘════════════════════════════════════════════╛\033[0m"
sleep 0.5
wget -q https://raw.githubusercontent.com/shakboss/wtgtnl1/main/installer/xrayinstaller.sh && chmod +x xrayinstaller.sh && ./xrayinstaller.sh
wget -q https://raw.githubusercontent.com/shakboss/wtgtnl1/main/installer/websocketinstaller.sh && chmod +x websocketinstaller.sh && ./websocketinstaller.sh
wget -q https://raw.githubusercontent.com/shakboss/wtgtnl1/main/installer/toolsinstaller.sh;chmod +x toolsinstaller.sh;./toolsinstaller.sh
wget -q https://raw.githubusercontent.com/shakboss/wtgtnl1/main/udp.sh && chmod +x udp.sh && ./udp.sh
clear
