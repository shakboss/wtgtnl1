...
wget raw.githubusercontent.com/mywtg/wtgtnl1/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
cd
wget -q -O /usr/bin/limit-ip "raw.githubusercontent.com/mywtg/wtgtnl1/main/limit/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
cd
