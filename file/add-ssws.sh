...
echo -e "User Quota       : ${Quota} GB" | tee -a /etc/xraylog/log-ss-$user.txt
...
echo -e "Port TLS       : 443, 8443, 2083, 2053" | tee -a /etc/xraylog/log-ss-$user.txt
echo -e "Port NTLS      : 80, 8880, 8080, 2082" | tee -a /etc/xraylog/log-ss-$user.txt
